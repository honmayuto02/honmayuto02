# 👋 自己紹介 
### 28卒 北海道理学院数学専攻修士課程１年　本間勇翔です。

数学的知見（グラフ理論・離散数理）を武器に、高度なシミュレーションやゲームエンジン技術の開発を目指している修士1年です。
「複雑な数理モデルを、効率的なコードで形にする」ことを信条としています。
...
- **技術**: C#, Unity, グラフ理論（隣接行列/リスト）, 数値計算アルゴリズム
